...
{
    public partial class CHumanFederateApp : Racon.CGenericFederate
    {
        ...
        #region Constructor
        public CHumanFederateApp(CSimulationManager parent) : this()
        {
        ...
        public override void FdAmb_ObjectDiscoveredHandler(object sender, HlaObjectEventArgs data)
        {
            ...
            if (data.ClassHandle == Som.HumanOC.Handle)
            {
                CHumanHlaObject datacollection = new CHumanHlaObject(data.ObjectInstance);
                datacollection.Type = Som.HumanOC;
